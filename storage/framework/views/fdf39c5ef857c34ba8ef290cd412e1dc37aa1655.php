                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-3">
                        <a data-toggle="modal" data-target="#modal-items-category" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('Add new category')); ?>">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h3 class="card-title text-primary text-uppercase"><?php echo e(__('Add first <Sub>
                                    </Sub> category')); ?></h3>
                                </div>.
                            </div>
                        </a>
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <script>
                                        ...
                                        function setParenttId(id) {
                                            alert(id);
                                            $('#parent_id').val(id);
                                        }
                                    </script>
                                    <?php if($canAdd): ?>
                                    <button class="btn btn-icon btn-1 btn-sm btn-primary" type="button" data-toggle="modal" data-target="#modal-items-category" data-id="<?= $category->id ?>" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('Add Subcategory')); ?> in <?php echo e($category->name); ?>" onClick=(setParenttId(<?php echo e($category->id); ?>))>
                    ...
                    <?php if($category->active == 1): ?>
                        ...
                        <div class="alert alert-warning">
                            <div class="row">
                                <div class="col">
                                    <span class="h2 font-weight-bold mb-0 text-white"><?php echo e($subcategory->name); ?></span>
                                </div>
                                <div class="col-auto">
                                    <div class="row">
                                        <?php if($canAdd): ?>
                                        <button class="btn btn-icon btn-1 btn-sm btn-primary" type="button" data-toggle="modal" data-target="#modal-new-item" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('Add item')); ?> in <?php echo e($subcategory->name); ?>" onClick=(setSelectedCategoryId(<?php echo e($subcategory->id); ?>))>
                                            <span class="btn-inner--icon"><i class="fa fa-plus"></i></span>
                                        </button>
                                        <?php else: ?>
                                        <a href="<?php echo e(route('plans.current')); ?>" class="btn btn-icon btn-1 btn-sm btn-warning" type="button">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="row row-grid">
                                    ...
                                    <?php $__currentLoopData = $subcategory->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-3">
                                    ...
                                    <?php if($canAdd): ?>
                                    <div class="col-lg-3">
                                        <a data-toggle="modal" data-target="#modal-new-item" data-toggle="tooltip" data-placement="top" href="javascript:void(0);" onclick=(setSelectedCategoryId(<?php echo e($subcategory->id); ?>))>
                                            <div class="card">
                                                <img class="card-img-top" src="<?php echo e(asset('images')); ?>/default/add_new_item.jpg" alt="...">
                                                <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', ['title' => __('Restaurant Menu Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CategoringManagement\resources\views/items/index.blade.php ENDPATH**/ ?>