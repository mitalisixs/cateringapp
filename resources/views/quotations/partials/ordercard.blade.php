<div class="card shadow">
    <div class="card-header border-0">
        ...
        <form method="GET">
            <div class="row align-items-center">
                <div class="col-8">
                    <h3 class="mb-0">{{ __('Quotations') }}</h3>
                </div>
    ...
    <div class="table-responsive">
        <table class="table align-items-center">
            ...
            @elseif (config('app.isqrsaas'))
                @include('quotations.partials.orderdisplay_local')
            @else
                @include('quotations.partials.orderdisplay')
            @endif
        </table>
    </div>
    @endif
    <div class="card-footer py-4">
        ...
        @else
            <h4>{{ __('You don`t have any quotations') }} ...</h4>
        @endif
    </div>
</div>