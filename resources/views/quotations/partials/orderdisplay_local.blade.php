...
<tr>
    <td>
        ...
        <a class="btn badge badge-success badge-pill" href="{{ route('quotations.show',$order->id )}}">#{{ $order->id }}</a>
    </td>
    ...
    <td>
        @include('quotations.partials.laststatus')
    </td>
    @include('quotations.partials.actions.table',['order' => $order ])
</tr>
@endforeach
</tbody>
