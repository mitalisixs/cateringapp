                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    ...
                                    @if($canAdd)
                                    <button class="btn btn-icon btn-1 btn-sm btn-primary" type="button" data-toggle="modal" data-target="#modal-items-category" data-id="<?= $category->id ?>" data-toggle="tooltip" data-placement="top" title="{{ __('Add Subcategory') }} in {{$category->name}}" onClick=(setParenttId({{ $category->id }}))>
                    ...
                    @if($category->active == 1)
                        ...
                        @foreach ( $subcategories as $subcategory)
                            <div class="alert alert-warning">
                                <div class="row">
                                    <div class="col">
                                        <span class="h2 font-weight-bold mb-0 text-white">{{ $subcategory->name }}</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="row">
                                            @if($canAdd)
                                            <button class="btn btn-icon btn-1 btn-sm btn-primary" type="button" data-toggle="modal" data-target="#modal-new-item" data-toggle="tooltip" data-placement="top" title="{{ __('Add item') }} in {{$subcategory->name}}" onClick=(setSelectedCategoryId({{ $subcategory->id }}))>
                                                <span class="btn-inner--icon"><i class="fa fa-plus"></i></span>
                                            </button>
                                            @else
                                            <a href="{{ route('plans.current')}}" class="btn btn-icon btn-1 btn-sm btn-warning" type="button">
                                            ...
                                            @endif
                                            <button class="btn btn-icon btn-1 btn-sm btn-warning" type="button" id="edit" data-toggle="modal" data-target="#modal-edit-category" data-toggle="tooltip" data-placement="top" title="{{ __('Edit Sub category') }} {{ $subcategory->name }}" data-id="<?= $subcategory->id ?>" data-name="<?= $subcategory->name ?>">
                                                <span class="btn-inner--icon"><i class="fa fa-edit"></i></span>
                                            </button>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <div class="row row-grid">
                                        ...
                                        @if($canAdd)
                                        <div class="col-lg-3">
                                            <a data-toggle="modal" data-target="#modal-new-item" data-toggle="tooltip" data-placement="top" href="javascript:void(0);" onclick=(setSelectedCategoryId({{ $subcategory->id }}))>
                                                <div class="card">
                                                    <img class="card-img-top" src="{{ asset('images') }}/default/add_new_item.jpg" alt="...">
                                                    <div class="card-body">
...
<script>
    $("[data-target='#modal-edit-category']").click(function() {
        ...
        //$('#cat_id').val(id);
        $('#cat_name').val(name);
        var  editUrl="{{URL::to('categories')}}/"+id;
